...
import com.a116042018022.greendao.entity.greendao.DaoMaster;
import com.a116042018022.greendao.entity.greendao.DaoSession;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, SynthesizerListener, RadioGroup.OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        window.addFlags(WindowManager.LayoutParams.FLAG_DISMISS_KEYGUARD  //取消系统锁屏
                ...
                | WindowManager.LayoutParams.FLAG_TURN_SCREEN_ON |  //让系统亮屏
                WindowManager.LayoutParams.FLAG_KEEP_SCREEN_ON  //保持亮屏
        );
    ...
    public void init() {
        ...
        //appid换成自己申请的，播放语音
        SpeechUtility.createUtility(this, SpeechConstant.APPID + "=22774b2c");
        ...
        playVioce = (ImageView) findViewById(R.id.play_voice);              //用于播放单词的按钮绑定id
