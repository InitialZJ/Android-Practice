...
public class WrongActivity extends AppCompatActivity implements View.OnClickListener, SynthesizerListener {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.play_vioce:                   //播放单词声音
                ...
                speechSynthesizer.startSpeaking(text, (SynthesizerListener) this);        //传给后台
                break;
